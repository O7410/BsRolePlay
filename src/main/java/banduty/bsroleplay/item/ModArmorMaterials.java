...
public enum ModArmorMaterials implements ArmorMaterial {
    POLICE("a", 15, new int[] {2, 6, 4, 1}, 9,
            SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0f, 0f, () -> Ingredient.ofItems(ModItems.ROLEPLAY_CORE)),

    HOLY("a", 25, new int[] {4, 0, 0, 0}, 0,
            SoundEvents.BLOCK_AMETHYST_BLOCK_PLACE, 1f, 0f, () -> Ingredient.ofItems(ModItems.ROLEPLAY_CORE)),

    PIRATE("a", 7, new int[] {1, 4, 2, 0}, 0,
            SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0f, 0f, () -> Ingredient.ofItems(ModItems.ROLEPLAY_CORE)),

    KING("a", 46, new int[] {0, 0, 0, 0}, 0,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0f, 0f, () -> Ingredient.ofItems(ModItems.ROLEPLAY_CORE)),
    ...
    PHARAOH("a", 27, new int[] {3, 0, 0, 0}, 25,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 1f, 0.1f, () -> Ingredient.ofItems(ModItems.ROLEPLAY_CORE)),
    ...
    PROTECTION("a", 11, new int[] {1, 4, 3, 2}, 0,
            SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 2f, 0.2f, () -> Ingredient.ofItems(ModItems.ROLEPLAY_CORE));
